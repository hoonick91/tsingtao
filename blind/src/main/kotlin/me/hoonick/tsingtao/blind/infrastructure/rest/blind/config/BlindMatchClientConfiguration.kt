...
@Configuration
class BlindMatchClientConfiguration(
    @Value("\${blind.match-host}") val host: String,

    ) {

    @Bean
    fun blindMatchClient(jacksonObjectMapper: ObjectMapper): BlindMatchClient {
        ...
        return factory.createClient(BlindMatchClient::class.java)
    }
}